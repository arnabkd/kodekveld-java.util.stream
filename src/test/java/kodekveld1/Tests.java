...
public class Tests {
	Task tasks = new Task(); 				//TODO Bruk denne dersom du vil teste dine egne metoter
	//Answars tasks = new Answars();  		//TODO Bruk denne dersom du vil kjøre løsningsforslaget
	...
	//Return all numbers with atleast two digits
